...
- (IBAction)btn1Click:(id)sender {
    ...
    [self post:@"user/json/pswdsms" params:parameters success:^(id responseObj) {
...
- (IBAction)btn2Click:(id)sender {
    ...
    [self post:@"user/json/pswdcheck" params:parameters success:^(id responseObj) {
        ...
        if ([[dict objectForKey:@"code"] intValue]==1) {
            ...
            if (model) {
                FindPwdTwo *c1 = [[FindPwdTwo alloc] initWithNibName:@"FindPwdTwo" bundle:nil];
                c1.uid = model.uuid;
